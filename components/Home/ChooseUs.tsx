...
const ChooseUs = () => {
 return (
  <section className='my-8'>
   <h2 className='text-xl font-medium text-center uppercase'>Why choose us?</h2>
   <hr className='border-gold-soft' />
   <TraitItem
    text={
     <>
      ...
      <span className='text-gold-soft'>we know what the grind feels like!</span>{' '}
      So we consider our mission as simple as this: to help people achieve
      smooth gaming experiences with less time invested into some boring and
      repetitive tasks.
     </>
    }
    Icon={GamingIconOne}
   ...
   <TraitItem
    text={
     <>
      ...
      We believe that our clients deserve the best prices on the market, and so
      we have made it our mission to always stay ahead of the competition and
      offer you{' '}
      <span className='text-gold-soft'>the best buying & selling rates.</span>
     </>
    }
    Icon={BestPricesIcon}
    iconOnRight={true}
   ...
   <TraitItem
    text={
     <>
      ...
      items safely, using tested and secure methods. Furthermore, we use only
      safe payment methods like{' '}
   ...
   <TraitItem
    text={
     <>
      ...
      We know how important time is for our clients. Because we value that, we
      dedicate ourselves to you and{' '}
      <span className='text-gold-soft'>we are online most of the day.</span> If
      you decide to purchase from us or just want to ask questions, contact us
      on discord, skype or live chat and you are sure to get the fastest
      response.
     </>
    }
    Icon={ClockIcon}
